    ...
    <div class="adv-search-2 adv_extended_class 18460 advanced_search_form_wrapper" data-postid="18460">
            ...
            <div>
              ...
              <div>
                ...
                const style = suggestion.active
                  ...
                  >
                    <span style={{color:"black",fontSize:"13px",fontFamily:"sans-serif"}}>{suggestion.description}</span>
                  </div>
                  );
                })}
              </div>
      ...
      />
       ...
       {/*   <div class="col-md-12 Check-Out calendar_icon">
          <input type="text" id="check_out" name="check_out" placeholder="Check-Out" class="advanced_select form-control custom_icon_class_input" 
