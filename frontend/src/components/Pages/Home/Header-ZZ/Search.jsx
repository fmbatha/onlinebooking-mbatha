    ...
    return (
        <div>
            ...
            <div className="header_media with_search_newtype">
                                   ...
                                   <div id="gmap_wrapper" className="" data-post_id="133" data-cur_lat="40.7274893" data-cur_long="-73.9950182" style={{height: 550}}>
                                          ...
                                          <div className="adv-search-2 adv_lower_class adv_extended_class 133 advanced_search_form_wrapper" data-postid="133">
                                                 <form role="search" method="get" action="./advanced-search/">
                                                        <div className="col-md-12 Where_do_you_want_to_go_? map_icon">
                                                               ...
                                                               <input type="text" id="search_location_autointernal" className="form-control" name="search_location" placeholder="Where do you want to go ?" value="" />
