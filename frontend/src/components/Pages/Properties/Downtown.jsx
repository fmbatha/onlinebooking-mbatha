                        ...
                        <div class="property_menu_wrapper_hidden prop_menu_search_stick_no">
                            ...
                            <div itemscope itemtype="http://schema.org/RentAction" class="content_wrapper listing_wrapper row">
                                   <div itemscope itemtype="http://schema.org/RentAction" class="row content-fixed-listing listing_type_1">
                                          <div class="col-md-8">
                                                 ...
                                                 <div class="single-content listing-content">
                                                        ...
                                                        <h1 itemprop="name" class="entry-title entry-prop">Downtown apartment</h1>
                                                        ...
                                                        <div class="listing_main_image_location" itemprop="location" itemscope itemtype="http://schema.org/Place">
                                                               <Link to="./../../city/washington/index.html" rel="tag">Washington</Link>, <Link to="./../../area/wesley-heights/index.html" rel="tag">Wesley Heights</Link>
                                                               <div class="schema_div_noshow" itemprop="name">Washington, , Wesley Heights</div>
                                                        </div>
                                                               ...
                                                               <div class="panel-body imagebody imagebody_new property_pictures_wrapper">
                                                                      ...
                                                                      <div id="carousel-listing" class="carousel slide post-carusel carouselvertical" data-ride="carousel" data-interval="false">
                                                                             ...
                                                                             <div class="carousel-inner">
                                                                                    <div class="item active" data-fancybox="website_rental_gallery" data-src="../../../assets/wp-content/uploads/2018/08/6-1-1-1.jpg" title="" data-caption="" rel="data-fancybox-thumb">
                                                                                           <img xx src={Rental} data-original="./wp-content/uploads/2018/08/6-1-1-1.jpg" alt="" class="img-responsive" />
                                                                                    </div>
                                                                                    <Link class="left vertical carousel-control" to="#carousel-listing" data-slide="prev">
                                                                                           <i class="icon-left-open-big"></i>
                                                                                    </Link>

                                                                                    <Link class="right vertical carousel-control" to="#carousel-listing" data-slide="next">
                                                                             ...
                                                                             <div class="carousel-indicators-wrapper">
                                                                                    <ol id="carousel-indicators-vertical">
                                                                                           <li data-target="#carousel-listing" data-slide-to="0" class="active">
                                                                                                  ...
                                                                                                  <img itemprop="image" src={Default} alt="slider" />
                                                                                           </li>
                                                                                    </ol>
                                                                             </div>
                                                                      </div>
                                                        ...
                                                        <div class="category_wrapper">
                                                               <div class="category_details_wrapper">
                                                                      <div class="actions_icon category_details_wrapper_icon"><Link to="./../../action/entire-home/index.html" rel="tag">Entire home</Link> <span class="property_header_separator">|</span></div>
                                                                      <div class="schema_div_noshow" itemprop="actionStatus">Entire home</div>
                                                                      <div class="types_icon category_details_wrapper_icon"><Link to="./../../listings/apartment/index.html" rel="tag">Apartment</Link><span class="property_header_separator">|</span></div>
                                                                      <div class="schema_div_noshow" itemprop="additionalType">Apartment</div>
                                                                      <div class="no_link_details category_details_wrapper_icon guest_header_icon">2 Guests</div>
                                                                      <span class="property_header_separator">|</span><span class="no_link_details category_details_wrapper_icon bedrooms_header_icon">1 Bedroom</span><span class="property_header_separator">|</span>
                                                               </div>
                                                               <Link to="#listing_calendar" class="check_avalability">Check Availability</Link>
                                                        </div>
                                                        ...
                                                        <div class="listing_description_wrapper panel-wrapper">
                                                               <div id="listing_description">
                                                                      ...
                                                                      <div class="panel-body" id="listing_description_content" itemprop="description">
                                                                             <p>Newly renovated apartment &#8211; just 2 minutes-walk from Opera. It is the perfect location for daily sightseeing (excellent transport) and evening activity. Excellent location: restaurants, cafes, pubs (ruin-pubs as well), shops, museums are all within walking distance to make your stay even more enjoyable and comfortable.</p>
                                                                             <p>Secured parking lot in front of the house.</p>
                                                                             <p>Enjoy your stay in a brand new feeling flat in the center of the city.</p>
                                                                      </div>
                                                               </div>
                                                        ...
                                                        <div class="custom_day_wrapper_mobile"></div>
                                                        <div class="panel-wrapper" id="listing_price">
                                                               <Link class="panel-title" data-toggle="collapse" data-parent="#accordion_prop_addr" to="#collapseOne"> <span class="panel-title-arrow"></span>Price Info</Link>
                                                               <div id="collapseOne" class="panel-collapse collapse in">
                                                                      <div class="panel-body panel-body-border" itemprop="priceSpecification">
                                                                             <div class="listing_detail list_detail_prop_price_per_night col-md-6"><span class="item_head">Price per night:</span> € 38</div>
                                                                             <div class="listing_detail list_detail_prop_price_per_night_7d col-md-6"><span class="item_head">Price per night (7d+):</span> € 30</div>
                                                                             <div class="listing_detail list_detail_prop_price_per_night_30d col-md-6"><span class="item_head">Price per night (30d+):</span> € 25</div>
                                                                             <div class="listing_detail list_detail_prop_price_cleaning_fee col-md-6"><span class="item_head">Cleaning Fee:</span> € 10 Single Fee</div>
                                                                             <div class="listing_detail list_detail_prop_price_tax_fee col-md-6"><span class="item_head">City Tax Fee:</span> € 5 Single Fee</div>
                                                                      </div>
                                                               </div>
                                                        </div>
                                                        ...
                                                        <div class="panel-wrapper">
                                                               {/* <!-- property address   --> */}
                                                               <Link class="panel-title" data-toggle="collapse" data-parent="#accordion_prop_addr" to="#collapseTwo"> <span class="panel-title-arrow"></span>Address </Link>
                                                               ...
                                                               <div id="collapseTwo" class="panel-collapse collapse in">
                                                                      <div class="panel-body panel-body-border">
                                                                             ...
                                                                             <div class="listing_detail list_detail_prop_city col-md-6"><span class="item_head">City:</span> <Link to="./../../city/washington/index.html" rel="tag">Washington</Link></div>
                                                                             <div class="listing_detail list_detail_prop_area col-md-6"><span class="item_head">Area:</span> <Link to="./../../area/wesley-heights/index.html" rel="tag">Wesley Heights</Link></div>
                                                                             ...
                                                                             <div class="listing_detail list_detail_prop_zip col-md-6"><span class="item_head">Zip:</span> 94123</div>
                                                        ...
                                                        {/* <!-- property details   --> */}
                                                        <div class="panel-wrapper">
                                                               <Link class="panel-title" id="listing_details" data-toggle="collapse" data-parent="#accordion_prop_addr" to="#collapseTree"><span class="panel-title-arrow"></span>Details</Link>
                                                               <div id="collapseTree" class="panel-collapse collapse in">
                                                                      <div class="panel-body panel-body-border">
                                                                             <div class="listing_detail list_detail_prop_id col-md-6"><span class="item_head">Property ID: </span> 18657</div>
                                                                             <div class="listing_detail list_detail_prop_size col-md-6"><span class="item_head">Property Size:</span> 50 m<sup>2</sup></div>
                                                                             <div class="listing_detail list_detail_prop_rooms col-md-6"><span class="item_head">Rooms:</span> 1</div>
                                                                             <div class="listing_detail list_detail_prop_bedrooms col-md-6"><span class="item_head">Bedrooms:</span> 1</div>
                                                                             <div class="listing_detail list_detail_prop_bathrooms col-md-6"><span class="item_head">Bathrooms:</span> 1</div>
                                                                             <div class="listing_detail list_detail_prop_check-in_hour col-md-6"><span class="item_head">Check-in Hour:</span> After 15 PM</div>
                                                                             ...
                                                                             <div class="listing_detail list_detail_prop_breakfast_included col-md-6"><span class="item_head">Breakfast Included:</span> Yes</div>
                                                                             <div class="listing_detail list_detail_prop_late_check-in col-md-6"><span class="item_head">Late Check-in:</span> free of charge</div>
                                                                             <div class="listing_detail list_detail_prop_optional_services col-md-6"><span class="item_head">Optional Services:</span> Pickup from airport.</div>
                                                                             <div class="listing_detail list_detail_prop_outdoor_facilities col-md-6"><span class="item_head">Outdoor Facilities:</span> garden, parking, pool, restaurant</div>
                                                                             <div class="listing_detail list_detail_prop_extra_people col-md-6"><span class="item_head">Extra People:</span> 1 extra bed available free of charge</div>
                                                                             <div class="listing_detail list_detail_prop_cancellation col-md-6"><span class="item_head">Cancellation:</span> Cancel up to 24 hours in advance.</div>
                                                                      </div>
                                                               </div>
                                                        </div>
                                                        <div class="panel-wrapper features_wrapper">
                                                               <Link class="panel-title" id="listing_ammenities" data-toggle="collapse" data-parent="#accordion_prop_addr" to="#collapseFour"><span class="panel-title-arrow"></span>Features</Link>
                                                               <div id="collapseFour" class="panel-collapse collapse in">
                                                                      <div class="panel-body panel-body-border">
                                                                             <div class="listing_detail col-md-12 feature_block_others">
                                                                                    ...
                                                                                    <div class="listing_detail col-md-6"><i class="fas fa-check checkon"></i>Air Conditioner</div>
                                                                                    ...
                                                                                    <div class="listing_detail col-md-6"><i class="fas fa-check checkon"></i>Non Smoking</div>
                                                                      ...
                                                                      <div class="listing_reviews_container">
                                                                             ...
                                                                             <div class="listing-review">
                                                                                    <div class="col-md-8 review-list-content norightpadding">
                                                                                           ...
                                                                                           <div class="property_ratings"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i> <span class="ratings-star">( 5 of 5)</span></div>

                                                                                           <div class="review-content">The flat was very clean and perfectly in line with the pictures, close to arsenal station and very quiet. We will return definitely.</div>
                                                                                    </div>
                                                                             </div>
                                                                      </div>
                                                               </div>
                                                 ...
                                                 <div class="property_page_container google_map_type1">
                                                        ...
                                                        <div class="google_map_on_list_wrapper">
                                                               ...
                                                               <div id="google_map_on_list" data-cur_lat="38.8909367934" data-cur_long="" data-post_id="18657"></div>
                                                        </div>
                                                 </div>
                                                 ...
                                                 <div class="similar_listings_wrapper">
                                                        <div class="similar_listings">
                                                               ...
                                                               <div class="similar_listings_wrapper_flex">
                                                                      <div itemscope itemtype="http://schema.org/Product" class="listing_wrapper col-md-6 property_unit_v1 property_flex" data-org="4" data-listid="94">
                                                                             <div class="property_listing" data-link="./properties/cozy-house-in-the-sunnyside/">
                                                                                    <div class="listing-unit-img-wrapper">
                                                                                           <Link to="./../cozy-house-in-the-sunnyside/index.html"><img itemprop="image" src="./../../wp-content/uploads/2018/08/8-1-1-1-400x314.jpg" class="b-lazy img-responsive wp-post-image lazy-hidden" alt="image" /></Link>
                                                                                    ...
                                                                                    <div class="title-container">
                                                                                           ...
                                                                                           <Link to="./../cozy-house-in-the-sunnyside/index.html" class="owner_thumb" >
                                                                                               <img src={Thumb} alt="" />
                                                                                           </Link>

                                                                                           <div class="category_name">
                                                                                                  <Link itemprop="url" to="./../cozy-house-in-the-sunnyside/index.html" class="listing_title_unit">
                                                                                                         <span itemprop="name"> Cozy House In The Sunnyside </span>
                                                                                                  </Link>
                                                                                                  <div class="category_tagline map_icon"><Link to="./../../area/wesley-heights/index.html" rel="tag">Wesley Heights</Link>, <Link to="./../../city/washington/index.html" rel="tag">Washington</Link></div>

                                                                                                  <div class="category_tagline actions_icon"><Link to="./../../listings/apartment/index.html" rel="tag">Apartment</Link> / <Link to="./../../action/entire-home/index.html" rel="tag">Entire home</Link></div>
                                                                                           </div>
                                          ...
                                          <div class="col-md-4 widget-area-sidebar listingsidebar2 listing_type_1" id="primary">
                                                 <div itemprop="price" class="listing_main_image_price">€ 38<span class="pernight_label"> per night</span></div>
                                ...
                                all                            "
                                                        ...
                                                        <div class="space_extra_opt"><input type="hidden" id="extra_options_key" value="" /></div>
                                                        <p class="full_form" id="add_costs_here"></p>
                                                        <input type="hidden" id="listing_edit" name="listing_edit" value="18657" />

                                                        <div class="submit_booking_front_wrapper"><input type="submit" id="submit_booking_front" data-maxguest="2" data-overload="0" data-guestfromone="0" class="wpb_btn-info wpb_btn-small wpestate_vc_button vc_button" value="Book Now" /> <input type="hidden" id="security-register-booking_front" name="security-register-booking_front" value="2f7cb0aee5" /><input type="hidden" name="_wp_http_referer" value="/properties/downtown-apartment/" /></div>

                                                        <div class="third-form-wrapper">
                                                               <div class="col-md-6 reservation_buttons">
                                                                      <div id="add_favorites" class="icon-fav-off" data-postid="18657">Add to Favorites</div>
                                                               </div>
                                                        ...
                                                        <div class="prop_social">
                                                               ...
                                                               <Link to="http://www.facebook.com/sharer.php?u=./properties/downtown-apartment/&amp;t=Downtown+apartment" target="_blank" class="share_facebook"><i class="fab fa-facebook-f"></i></Link>
                                                               <Link to="http://twitter.com/home?status=Downtown+apartment+.%2Fproperties%2Fdowntown-apartment%2F" class="share_tweet" target="_blank"><i class="fab fa-twitter"></i></Link>
                                                               <Link to="mailto:email@email.com?subject=Downtown+apartment&amp;body=.%2Fproperties%2Fdowntown-apartment%2F" class="share_email" target="_blank"><i class="far fa-envelope"></i></Link>
                                                               <Link to="http://pinterest.com/pin/create/button/?url=./properties/downtown-apartment/&amp;media=./wp-content/uploads/2018/08/6-1-1-1-1920x790.jpg&amp;description=Downtown+apartment" target="_blank" class="share_pinterest"> <i class="fab fa-pinterest-p fa-2"></i> </Link>
                                                        </div>
                                                 </div>
                                                 ...
                                                 <div class="owner_area_wrapper_sidebar" id="listing_owner">
                                                        <div class="agentpic-wrapper">
                                                               ...
                                                               <h3 itemprop="agent">downtown-apartment</h3>
                                                        </div>

                                                        <div class="agentpic-wrapper">
                                                               <div id="contact_me_long" class="" data-postid="18657">Contact Owner</div>
                                                        </div>
                                                 </div>
                                                 ...
                                                 <ul class="xoxo listingsidebar">
                                                               ...
                                                               <div class="wp-block-group">
                                                                      <div class="wp-block-group__inner-container">
                                                                             ...
                                                                             <ul class="wp-block-latest-posts__list wp-block-latest-posts">
                                                                                    <li><Link to="./../../2021/12/08/hello-world/index.html">Hello world!</Link></li>
                                                                                    <li><Link to="./../../2015/04/21/what-guests-want-to-know/index.html">What Guests Want to Know</Link></li>
                                                                                    <li><Link to="./../../2015/04/21/how-to-be-a-great-host/index.html">How to be a Great Host for Renters</Link></li>
                                                                                    <li><Link to="./../../2015/04/21/offering-a-welcoming-space/index.html">Offering a Full Welcoming Space</Link></li>
                                                                                    <li><Link to="./../../2015/04/20/best-beaches-for-an-autumn-vacation/index.html">Best Beaches For An Autumn Vacation</Link></li>
                                                                             </ul>
                                                                      </div>
                                                               </div>
                                                        </li>
                                                                      ...
                                                                      <div class="wp-block-group__inner-container">
                                                                             ...
                                                                             <ol class="wp-block-latest-comments">
                                                                                    <li class="wp-block-latest-comments__comment">
                                                                                           <Link>
                                                                                           <article>
                                                                                                  <footer class="wp-block-latest-comments__comment-meta"><Link class="wp-block-latest-comments__comment-author" to="https://wordpress.org/">A WordPress Commenter</Link> on <Link class="wp-block-latest-comments__comment-link" to="./../../2021/12/08/hello-world/index.html#comment-1">Hello world!</Link></footer>
                                                                                           </article>
                                                                                           </Link>
                                                                                    </li>
                                                                                    <li class="wp-block-latest-comments__comment">
                                                                                           <Link>
                                                                                           <article>
                                                                                                  <footer class="wp-block-latest-comments__comment-meta"><span class="wp-block-latest-comments__comment-author">user</span> on <Link class="wp-block-latest-comments__comment-link" to="./../terrace-condo-penn-station/index.html#comment-10">Nice Terrace Condo Penn Station</Link></footer>
                                                                                           </article>
                                                                                           </Link>
                                                                                    </li>
                                                                                    <li class="wp-block-latest-comments__comment">
                                                                                           <Link>
                                                                                           <article>
                                                                                                  <footer class="wp-block-latest-comments__comment-meta"><span class="wp-block-latest-comments__comment-author">user</span> on <Link class="wp-block-latest-comments__comment-link" to="./../terrace-condo-penn-station/index.html#comment-9">Nice Terrace Condo Penn Station</Link></footer>
                                                                                           </article>
                                                                                           </Link>
                                                                                    </li>
                                                                                    <li class="wp-block-latest-comments__comment">
                                                                                           <Link>
                                                                                           <article>
                                                                                                  <footer class="wp-block-latest-comments__comment-meta"><span class="wp-block-latest-comments__comment-author">user</span> on <Link class="wp-block-latest-comments__comment-link" to="./../terrace-condo-penn-station/index.html#comment-8">Nice Terrace Condo Penn Station</Link></footer>
                                                                                           </article>
                                                                                           </Link>
                                                                                    </li>
                                                                                    <li class="wp-block-latest-comments__comment">
                                                                                           <Link>
                                                                                           <article>
                                                                                                  <footer class="wp-block-latest-comments__comment-meta"><span class="wp-block-latest-comments__comment-author">demo</span> on <Link class="wp-block-latest-comments__comment-link" to="./../summerlin-cabin-perfect-holiday/index.html#comment-7">Summerlin Cabin &#8211; Perfect Holiday</Link></footer>
                                                                                           </article>
                                                                                           </Link>
                                                                                    </li>
                                                                             </ol>
                                                        ...
                                                        <li id="search-1" class="widget-container widget_search">
                                                               <form method="get" id="searchform" action="./">
                                                                      <input type="hidden" id="wpestate_search_form_nonce" name="wpestate_search_form_nonce" value="5971cb409b" /><input type="hidden" name="_wp_http_referer" value="/properties/downtown-apartment/" /> <input type="text" class="form-control" name="s" id="s" placeholder="Search" />
                                                        ...
                                                        <li id="recent-posts-2" class="widget-container widget_recent_entries">
                                                               ...
                                                               <ul>
                                                                      <li>
                                                                             <Link to="./../../2021/12/08/hello-world/index.html">Hello world!</Link>
                                                                      </li>
                                                                      <li>
                                                                             <Link to="./../../2015/04/21/what-guests-want-to-know/index.html">What Guests Want to Know</Link>
                                                                      </li>
                                                                      <li>
                                                                             <Link to="./../../2015/04/21/how-to-be-a-great-host/index.html">How to be a Great Host for Renters</Link>
                                                                      </li>
                                                                      <li>
                                                                             <Link to="./../../2015/04/21/offering-a-welcoming-space/index.html">Offering a Full Welcoming Space</Link>
                                                                      </li>
                                                                      <li>
                                                                             <Link to="./../../2015/04/20/best-beaches-for-an-autumn-vacation/index.html">Best Beaches For An Autumn Vacation</Link>
                                                                      </li>
                                                               </ul>
                                                        </li>
                                                        <li id="recent-comments-2" class="widget-container widget_recent_comments">
                                                               ...
                                                               <ul id="recentcomments">
                                                                      <li class="recentcomments">
                                                                             <span class="comment-author-link"><Link to="https://wordpress.org/" rel="external nofollow ugc" class="url">A WordPress Commenter</Link></span> on <Link to="./../../2021/12/08/hello-world/index.html#comment-1">Hello world!</Link>
                                                                      </li>
                                                                      <li class="recentcomments"><span class="comment-author-link">user</span> on <Link to="./../terrace-condo-penn-station/index.html#comment-10">Nice Terrace Condo Penn Station</Link></li>
                                                                      <li class="recentcomments"><span class="comment-author-link">user</span> on <Link to="./../terrace-condo-penn-station/index.html#comment-9">Nice Terrace Condo Penn Station</Link></li>
                                                                      <li class="recentcomments"><span class="comment-author-link">user</span> on <Link to="./../terrace-condo-penn-station/index.html#comment-8">Nice Terrace Condo Penn Station</Link></li>
                                                                      <li class="recentcomments"><span class="comment-author-link">demo</span> on <Link to="./../summerlin-cabin-perfect-holiday/index.html#comment-7">Summerlin Cabin &#8211; Perfect Holiday</Link></li>
                                                               </ul>
                                                        </li>
                                                        <li id="archives-1" class="widget-container widget_archive">
                                                               <h3 class="widget-title-sidebar">Archives</h3>
                                                               <ul>
                                                                      <li><Link to="./../../2021/12/index.html">December 2021</Link></li>
                                                                      <li><Link to="./../../2015/04/index.html">April 2015</Link></li>
                                                               </ul>
                                                        </li>
                                                        <li id="categories-2" class="widget-container widget_categories">
                                                               ...
                                                               <ul>
                                                                      <li class="cat-item cat-item-13">
                                                                             <Link to="./../../category/holiday-ideas/index.html">Holiday Ideas</Link>
                                                                      </li>
                                                                      <li class="cat-item cat-item-14">
                                                                             <Link to="./../../category/hospitality/index.html">Hospitality</Link>
                                                                      </li>
                                                                      <li class="cat-item cat-item-1">
                                                                             <Link to="./../../category/uncategorized/index.html">Uncategorized</Link>
                                                                      </li>
                                                               </ul>
                                                        </li>
                                                        <li id="meta-1" class="widget-container widget_meta">
                                                               ...
                                                               <ul>
                                                                      <li><Link to="./../../wp-login.php">Log in</Link></li>
                                                                      <li><Link to="./../../feed/index.html">Entries feed</Link></li>
                                                                      <li><Link to="./../../comments/feed/index.html">Comments feed</Link></li>

                                                                      <li><Link to="https://wordpress.org/">WordPress.org</Link></li>
                                                               </ul>
                                                        </li>
                                                        <li id="wpestate_advanced_search_widget-1" class="widget-container advanced_search_sidebar">
                                                               ...
                                                               <div class="adv-search-2 adv_lower_class adv_extended_class 18657 advanced_search_form_wrapper" data-postid="18657">
                                                                      <form role="search" method="get" action="./advanced-search/">
                                                                             ...
                                                                             <input type="hidden" id="wpestate_regular_search_nonce" name="wpestate_regular_search_nonce" value="061de97250" /><input type="hidden" name="_wp_http_referer" value="/properties/downtown-apartment/" />
                                                        ...
                                                        <li id="wpestate_login_widget-1" class="widget-container loginwd_sidebar">
                                                               <input type="hidden" id="security-login-forgot_wd" name="security-login-forgot_wd" value="85e46689b6" /><input type="hidden" name="_wp_http_referer" value="/properties/downtown-apartment/" />
                                                               <div class="login_sidebar">
                                                                      ...
                                                                      <div class="login_form" id="login-div">
                                                                             ...
                                                                             <input type="hidden" id="security-login-wd" name="security-login-wd" value="698d81b737-1638969716" />
                                                                             <button class="wpb_button wpb_btn-info wpb_regularsize wpestate_vc_button vc_button" id="wp-login-but-wd">Login</button>

                                                                             <div class="navigation_links">
                                                                                    <Link to="#" id="widget_register_sw">Don&#039;t have an account?</Link> |
                                                                                    <Link to="#" id="forgot_pass_widget">Forgot Password?</Link>
                                                                             </div>
                                                                      ...
                                                                      <div class="login_form" id="register-div">
                                                                             ...
                                                                             <input type="checkbox" name="terms" id="user_terms_register_wd" /><label id="user_terms_register_wd_label" for="user_terms_register_wd">I agree with <Link to="./../../terms-and-conditions/index.html" target="_blank" id="user_terms_register_topbar_link">terms &amp; conditions</Link> </label><input type="hidden" id="security-register-wd" name="security-register-wd" value="6de05b524d-1638969716" /><button class="wpb_button wpb_btn-info wpb_regularsize wpestate_vc_button vc_button" id="wp-submit-register_wd">Register</button>
                                                                             <div class="login-links">
                                                                                    <Link to="#" id="widget_login_sw">Back to Login</Link>
                                                                             </div>
                                                                      </div>
                                                               </div>
                                                               ...
                                                               <div class="login_form" id="forgot-pass-div_shortcode">
                                                                      ...
                                                                      <div class="login-links shortlog">
                                                                             <Link to="#" id="return_login_shortcode">Return to Login</Link>
                                                                      </div>
                                                               </div>
                                                        </li>
                                                        <li id="wpestate_footer_latest_widget-1" class="widget-container latest_listings">
                                                               ...
                                                               <div itemscope itemtype="http://schema.org/Product" class="listing_wrapper col-md-12 property_unit_v1 property_flex" data-org="12" data-listid="137">
                                                                      <div class="property_listing" data-link="./properties/huge-sunny-villa-east-side/">
                                                                             <div class="listing-unit-img-wrapper">
                                                                                    <Link to="./../huge-sunny-villa-east-side/index.html"><img itemprop="image" src="./../../wp-content/uploads/2018/08/9-1-1-1-400x314.jpg" class="b-lazy img-responsive wp-post-image lazy-hidden" alt="image" /></Link>
                                                                                    <div class="price_unit_wrapper"></div>
                                                                             </div>

                                                                             <div class="title-container">
                                                                                    <div class="category_name">
                                                                                           <Link itemprop="url" to="./../huge-sunny-villa-east-side/index.html" class="listing_title_unit">
                                                               ...
                                                               <div itemscope itemtype="http://schema.org/Product" class="listing_wrapper col-md-12 property_unit_v1 property_flex" data-org="12" data-listid="119">
                                                                      <div class="property_listing" data-link="./properties/beautiful-cabin-simple-price/">
                                                                             <div class="listing-unit-img-wrapper">
                                                                                    <Link to="./../beautiful-cabin-simple-price/index.html"><img itemprop="image" src="./../../wp-content/uploads/2018/08/4-1-1-1-scaled-1-400x314.jpg" class="b-lazy img-responsive wp-post-image lazy-hidden" alt="image" /></Link>
                                                                                    <div class="price_unit_wrapper"></div>
                                                                             </div>

                                                                             <div class="title-container">
                                                                                    <div class="category_name">
                                                                                           <Link itemprop="url" to="./../beautiful-cabin-simple-price/index.html" class="listing_title_unit">
                                                               ...
                                                               <div itemscope itemtype="http://schema.org/Product" class="listing_wrapper col-md-12 property_unit_v1 property_flex" data-org="12" data-listid="115">
                                                                      <div class="property_listing" data-link="./properties/victorian-bed-breakfast/">
                                                                             <div class="listing-unit-img-wrapper">
                                                                                    <Link to="./../victorian-bed-breakfast/index.html"><img itemprop="image" src={Bed} class="b-lazy img-responsive wp-post-image lazy-hidden" alt="image" /></Link>
                                                                                    <div class="price_unit_wrapper"></div>
                                                                             </div>

                                                                             <div class="title-container">
                                                                                    <div class="category_name">
                                                                                           <Link itemprop="url" to="./../victorian-bed-breakfast/index.html" class="listing_title_unit">
                                                 ...
                                                 <ul class="xoxo">
                                                        <li id="wpestate_footer_latest_widget-2" class="widget-container latest_listings">
                                                               ...
                                                               <div itemscope itemtype="http://schema.org/Product" class="listing_wrapper col-md-12 property_unit_v1 property_flex" data-org="12" data-listid="137">
                                                                      <div class="property_listing" data-link="./properties/huge-sunny-villa-east-side/">
                                                                             <div class="listing-unit-img-wrapper">
                                                                                    <Link to="./../huge-sunny-villa-east-side/index.html"><img itemprop="image" src={Sunny} class="b-lazy img-responsive wp-post-image lazy-hidden" alt="image" /></Link>
                                                                                    <div class="price_unit_wrapper"></div>
                                                                             </div>
                                                               ...
                                                               <div itemscope itemtype="http://schema.org/Product" class="listing_wrapper col-md-12 property_unit_v1 property_flex" data-org="12" data-listid="119">
                                                                      <div class="property_listing" data-link="./properties/beautiful-cabin-simple-price/">
                                                                             <div class="listing-unit-img-wrapper">
                                                                                    <Link to="./../beautiful-cabin-simple-price/index.html"><img itemprop="image" src={Cabin} class="b-lazy img-responsive wp-post-image lazy-hidden" alt="image" /></Link>
                                                                                    <div class="price_unit_wrapper"></div>
                                                                             </div>
                                                               ...
                                                               <div itemscope itemtype="http://schema.org/Product" class="listing_wrapper col-md-12 property_unit_v1 property_flex" data-org="12" data-listid="115">
                                                                      <div class="property_listing" data-link="./properties/victorian-bed-breakfast/">
                                                                             <div class="listing-unit-img-wrapper">
                                                                                    <Link to="./../victorian-bed-breakfast/index.html"><img itemprop="image" src={Victoria} class="b-lazy img-responsive wp-post-image lazy-hidden" alt="image" /></Link>
                                                                                    <div class="price_unit_wrapper"></div>
                                                                             </div>
                     ...
                     <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                   ...
                                   <div class="modal-body">
                                          ...
                                          <input type="hidden" id="property_id" name="property_id" value="18657" />
                                          ...
                                          <button type="submit" id="submit_mess_front" class="wpb_button submit_mess_front_class wpb_btn-info wpb_regularsize wpestate_vc_button vc_button">Send Message</button><input type="hidden" id="wprentals_submit_mess_front_nonce" value="c1aacdeea2" />
                                   </div>
                                   {/* <!-- /.modal-body --> */}
                            </div>
                            {/* <!-- /.modal-content --> */}
                                   ...
                                   <div class="modal-body">
                                          <div id="ajax_login_div" class="">
                                                 <div class="login_form" id="login-div">
                                                        ...
                                                        <input type="hidden" id="security-login" name="security-login" value="c868b50cac-1638969717" />

                                                        <button id="wp-login-but" class="wpb_button wpb_btn-info wpb_regularsize wpestate_vc_button vc_button" data-mixval="18657">Login</button>
                                                        <div class="navigation_links">
                                          ...
                                          <div id="ajax_register_div" class="">
                                                 <div class="login_form shortcode-login">
                                                        ...
                                                        <input type="hidden" id="security-register" name="security-register" value="d210b67c67-1638969717" />
                                                 </div>
