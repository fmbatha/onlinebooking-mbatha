                  ...
                  <div class="panel-body imagebody imagebody_new property_pictures_wrapper">
                    ...
                    <div id="carousel-listing" class="carousel slide post-carusel carouselvertical" data-ride="carousel" data-interval="false">
                      ...
                      {propertyImages.map((value, key) => {
                        ...
                        <div class="item" data-fancybox="website_rental_gallery" data-src={"http://localhost:3001/uploads/"+value.id+"/"+value.photo} title="" data-caption="" rel="data-fancybox-thumb">
                        <img src={"http://localhost:3001/uploads/"+value.id+"/"+value.photo} data-original={Original} alt="" class="img-responsive" />
                      </div>
                        </div>
                        )
                      })}
                      ...
                      <div class="carousel-indicators-wrapper">
                        ...
                        {propertyImages.map((value, key) => {
                          return (
                            ...
                            <img itemprop="image" src={"http://localhost:3001/uploads/"+value.id+"/"+value.photo} alt="slider" />
