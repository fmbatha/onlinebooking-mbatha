...
function Booking(props) {
    ...
    const bgColor = () => {
        let h = ((new Date(props.book.start_date)).getTime() * 21 * props.book.PropertyId) % 255;
    ...
    let number_of_days = ((new Date(props.book.end_date)).getTime() - (new Date(props.book.start_date)).getTime()) / (60 * 60 * 24 * 1000) + 1;
