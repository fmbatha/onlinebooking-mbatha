 ...
 const [isLoading,setLoading]=useState(false);
  ...
  const handleUserChange= async (event) => {
   ...
   const handlePropertyChange=async (event) => {
    ...
    let { data } = await  Axios.get(`http://localhost:3001/propertyprices/byPropertyId/${selectedProperty}`)
    ...
    const add_customer = () => {
      ...
      const editBookingDetails = () => {
        ...
        Axios.put(`http://localhost:3001/booking/updatebooking/${id}`, data).then((response) => {
