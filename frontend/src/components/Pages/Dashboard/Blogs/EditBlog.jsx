...
const Blogs =()  =>{
    ...
    const EditBlogs = async (e) => {
        e.preventDefault();
        await axios.put(`http://localhost:3003/blogs/${id}`,{
            title: tiEditBlogstle,
            blog_img: blog_img
            //   status: status
    ...
    const getBlogById = async () => {
        ...
        setBlog_img(response.data.blog_img);
  ...
  return (
        ...
        <div class="row">
              ...
              <div class="float-lg-left">
                    <Link class='btn btn-primary' onClick={EditBlogs} to='/bloglist'>
                        Submit
                    </Link>
                </div> 
              </div>
