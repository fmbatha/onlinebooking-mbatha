                ...
                <div class="header_wrapper header_type1 header_align_left header_wide_no">
                        <div class="header_wrapper_inside">
                            ...
                            <div class="content_wrapper row">
                                   <div itemscope itemtype="http://schema.org/Article" id="post" class="row content-fixed post-220 post type-post status-publish format-standard has-post-thumbnail hentry category-holiday-ideas category-hospitality category-uncategorized tag-holiday-ideas tag-hospitality">
                                          <div class="col-md-12 breadcrumb_container">
                                                 <ol class="breadcrumb">
                                                        ...
                                                        <li class="active">Offering a Full Welcoming Space</li>
                                                 </ol>
                                          </div>
                                          <div class="col-md-12">
                                                 ...
                                                 <img itemprop="image" src="./../../../../wp-content/uploads/2015/04/restaurant-1-1-1170x921.jpeg" class="schema_div_noshow b-lazy img-responsive" alt="" />
                                                 ...
                                                 <div class="single-content single-blog">
                                                        <h1 itemprop="headline" class="entry-title single-title">Offering a Full Welcoming Space</h1>
                                                        <div class="meta-element-head" itemprop="datePublished">Published on April 21, 2015 by <span itemprop="author">admin</span></div>

                                                        <p>Exceptional hospitality can come through in a lot of ways, but it most definitely starts with a clean space. And while cleaning might not be the most fun part of hosting, it doesn’t have to be difficult! Here are a few tips and tricks to help you get swept up in an effective and easy cleaning routine.</p>
                                                        <p>
                                                               <strong>Focus on the trouble spots</strong><br />
                                                        ...
                                                        <p>
                                                               <b>Make room for your guests’ things</b><br />
                                                        ...
                                                        <p>
                                                               <b>Pay attention to details</b><br />
                                                               Once you’ve gotten your space clean and ready for your next guest, check the details:
                                                        </p>
                                                        <ul>
                                                               <li>Look for stray hairs on the couch</li>
                                                               <li>Clean off dust on the edges of shelves, picture frames, and doorways</li>
                                                               <li>Wipe down all the surfaces of fixtures and appliances</li>
                                                               <li>Check the kitchen counter for crumbs</li>
                                                               <li>Sweep or vacuum under the furniture</li>
                                                        </ul>
                                                        ...
                                                        <div class="meta-info">
                                                               ...
                                                               <div class="prop_social">
                                                                      ...
                                                                      <a href="http://www.facebook.com/sharer.php?u=./2015/04/21/offering-a-welcoming-space/&amp;t=Offering+a+Full+Welcoming+Space" target="_blank" class="share_facebook"><i class="fab fa-facebook-f"></i></a>
                                                                      <a href="http://twitter.com/home?status=Offering+a+Full+Welcoming+Space+.%2F2015%2F04%2F21%2Foffering-a-welcoming-space%2F" class="share_tweet" target="_blank"><i class="fab fa-twitter"></i></a>
                                                                      <a href="mailto:email@email.com?subject=Offering+a+Full+Welcoming+Space&amp;body=.%2F2015%2F04%2F21%2Foffering-a-welcoming-space%2F" class="share_email" target="_blank"><i class="far fa-envelope"></i></a>
                                                                      <a href="http://pinterest.com/pin/create/button/?url=./2015/04/21/offering-a-welcoming-space/&amp;media=./wp-content/uploads/2015/04/restaurant-1-1-1920x790.jpeg&amp;description=Offering+a+Full+Welcoming+Space" target="_blank" class="share_pinterest"> <i class="fab fa-pinterest-p fa-2"></i> </a>
                                                               </div>
                                                        </div>
                                                 </div>
                                                 ...
                                                 <div class="related_posts blog_list_wrapper row">
                                                        ...
                                                        <div class="col-md-4 property_flex">
                                                               <div class="blog_unit_back" data-link="./2015/04/21/how-to-be-a-great-host/">
                                                                      ...
                                                                      <div class="blog-title">
                                                                             <a href="./../how-to-be-a-great-host/index.html" class="blog-title-link"> How to be a Great Host for R... </a>
                                                 ...
                                                 <div class="wrapper_content">
                                                        <div id="comments">
                                                               <h2>4 thoughts on &ldquo;<span>Offering a Full Welcoming Space</span>&rdquo;</h2>
                                                               ...
                                                               <ul class="commentlist">
                                                                             ...
                                                                             <div id="comment-16" class="comment">
                                                                                    <div class="comment-meta">
                                                                                           <div class="comment-author vcard">
                                                                                                  <div class="comment_name">Simone</div>
                                                                                    ...
                                                                                    <div class="comment-content">
                                                                                           ...
                                                                                           <a rel="nofollow" class="comment-reply-link" href="./index.html?replytocom=16#respond" data-commentid="16" data-postid="220" data-belowelement="comment-16" data-respondelement="respond" data-replyto="Reply to Simone" aria-label="Reply to Simone"><i class="fas fa-reply"></i> Reply</a>
                                                                                    </div>
                                                                             </div>
                                                                             {/* <!-- #comment-## --> */}
                                                                      </li>
                                                                      ...
                                                                      <li class="comment odd alt thread-odd thread-alt depth-1" id="li-comment-17">
                                                                             ...
                                                                             <div id="comment-17" class="comment">
                                                                                    ...
                                                                                    <div class="comment-content">
                                                                                           ...
                                                                                           <a rel="nofollow" class="comment-reply-link" href="./index.html?replytocom=17#respond" data-commentid="17" data-postid="220" data-belowelement="comment-17" data-respondelement="respond" data-replyto="Reply to Laura" aria-label="Reply to Laura"><i class="fas fa-reply"></i> Reply</a>
                                                                                    </div>
                                                                             </div>
                                                                             {/* <!-- #comment-## --> */}
                                                                             <ul class="children">
                                                                                    <li class="comment even depth-2" id="li-comment-19">
                                                                                           ...
                                                                                           <div id="comment-19" class="comment">
                                                                                                  ...
                                                                                                  <div class="comment-content">
                                                                                                         <p>We want the 2015 WP Rentals to inspire, equip, and celebrate you. And we want to gather with the host community to learn how to do what we do better. Let’s make this year’s summit one to remember! Stay tuned as we reveal exciting details in the days to come.</p>

                                                                                                         <a rel="nofollow" class="comment-reply-link" href="./index.html?replytocom=19#respond" data-commentid="19" data-postid="220" data-belowelement="comment-19" data-respondelement="respond" data-replyto="Reply to Simone" aria-label="Reply to Simone"><i class="fas fa-reply"></i> Reply</a>
                                                                                                  </div>
                                                                                           </div>
                                                                                           {/* <!-- #comment-## --> */}
                                                                                    </li>
                                                                      ...
                                                                      <li class="comment odd alt thread-even depth-1" id="li-comment-18">
                                                                             ...
                                                                             <div id="comment-18" class="comment">
                                                                                    ...
                                                                                    <div class="comment-content">
                                                                                           <p>WP Rentals can benefit both hosts and travelers. Hosts get to meet people from around the world while making a little extra money, and travelers can often stay for less than the cost of a hotel room. In addition, many travelers enjoy accommodations that offer a different experience from standard hotels.</p>

                                                                                           <a rel="nofollow" class="comment-reply-link" href="./index.html?replytocom=18#respond" data-commentid="18" data-postid="220" data-belowelement="comment-18" data-respondelement="respond" data-replyto="Reply to Simone" aria-label="Reply to Simone"><i class="fas fa-reply"></i> Reply</a>
                                                                                    </div>
                                                                             </div>
                                                                             {/* <!-- #comment-## --> */}
                                                                      </li>
                                                               ...
                                                               <div id="respond" class="comment-respond">
                                                                      ...
                                                                      <form action="./wp-comments-post.php" method="post" id="commentform" class="comment-form">
                                                                             ...
                                                                             <p class="form-submit">
                                                                                    <input name="submit" type="submit" id="submit" class="submit" value="Post Comment" /> <input type="hidden" name="comment_post_ID" value="220" id="comment_post_ID" />
